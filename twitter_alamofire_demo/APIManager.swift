...
class APIManager: SessionManager {
    ...
    // App keys
    static let consumerKey = "1iCJDUlqr2A8TtyPknsWPSzr7"
    static let consumerSecret = "n1LvkdPeNc0IAQlTl0Dx1TC63HdQOF1WGdBT5qdQghzs3XKTMW"
    ...
    func logout() {
        ...
        // Deauthorize OAuth tokens; do this to prompt for username and password again upon logging out
...
//        }
    ...
    func composeTweet(_ tweet: Tweet, completion: @escaping(Tweet?, Error?) -> ()) {
    ...
    func getUserTimeline(_ tweet: Tweet, completion: @escaping(Tweet?, Error?) -> ()) {
